class GameSession::Quest < Data.define(:key, :title, :hook, :brief)
  ...
  ALL = [
    new(key: "lost_caravan", title: "Kayıp Kervan", hook: "Boranda kaybolan tuz kervanının izi.",
    ...
    new(key: "sunken_village", title: "Gölün Sırrı", hook: "Suyun altında kalmış eski bir köy.",
