class GameSession::Quest < Data.define(:key, :title, :hook, :glyph, :brief)
  extend Catalog

  ALL = [
    new(key: "lost_caravan", title: "The Lost Caravan", hook: "The trail of a salt caravan lost in a blizzard.", glyph: "bell",
    ...
    new(key: "sunken_village", title: "The Lake's Secret", hook: "An old village left under the water.", glyph: "compass",
